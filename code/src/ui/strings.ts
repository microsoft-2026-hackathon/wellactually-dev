...
export const uiMessages = {
  ...
  composerPlaceholder: "Pair Programming with WellActually...",
  pairRole: "페어 · 읽기 전용",
  pairRoleHelp: "페어는 읽기 전용으로 논의하며 파일 수정이나 드라이버 제어는 하지 않습니다.",
  modelControls: "페어 모델 설정", model: "모델",
  selectModel: "모델 선택 · 현재 {model}",
  modelHelp: "대화는 유지되며 선택한 모델은 다음 메시지에 적용됩니다.",
  selectReasoning: "추론 수준 선택 · 현재 {level}",
  reasoningLabel: "추론: {level}",
  reasoningHelp: "선택한 추론 수준은 다음 메시지에 적용됩니다.",
  reasoningUnknown: "이 모델에서 선택 가능한 추론 수준을 확인합니다.",
  reasoningUnavailable: "이 모델은 선택 가능한 추론 수준을 제공하지 않으며 모델 자체의 설정을 사용합니다.",
  reasoningDefaultHelp: "기본은 모델이 제공하는 추론 설정을 사용합니다.",
  reasoningDefault: "기본", reasoningNone: "사용 안 함", reasoningLow: "낮음", reasoningMedium: "보통",
  reasoningHigh: "높음", reasoningXhigh: "매우 높음", reasoningMax: "최대",
  modelBusyShort: "모델 설정 중",
  modelBusyComposer: "모델 설정을 마친 뒤 메시지를 보내세요. 작성한 내용은 유지됩니다.",
